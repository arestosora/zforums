                    ...
                    <div v-for="post in sharedPosts" :key="post.id"
                        ...
                        <div class="header flex items-center mb-4">
                            ...
                            <div class="user-info flex-grow">
                                ...
                                <div class="shared-post text-gray-500 text-sm">{{ authState.user?.name }} has shared
                                    this post</div>
                            </div>
                        </div>
                        ...
                        <div class="actions flex justify-between text-gray-500">
                            ...
                            <button @click="navigateToComments(post.id)" class="action-button hover:text-green-500">
                                <i class="pi pi-comments mr-1"></i>Comment <span class="ml-1">{{ post.comments.length
                                    }}</span>
                            </button>
...
.edit-icon {
    background: none;
    border: none;
    color: rgba(144, 238, 144, 0.5); /* Color transparente lightgreen */
    cursor: pointer;
    font-size: 1.5rem;
    transition: color 0.3s ease;
}
...
.edit-icon:hover {
    color: rgba(144, 238, 144, 0.8); /* Un poco más oscuro al pasar el ratón */
}
...
input[type="text"], input[type="email"], input[type="password"] {
    background-color: transparent;
    color: rgba(144, 238, 144, 0.5); /* Color transparente lightgreen */
    border: 1px solid rgba(144, 238, 144, 0.5); /* Borde transparente lightgreen */
}

input[type="text"]:focus, input[type="email"]:focus, input[type="password"]:focus {
    border-color: rgba(144, 238, 144, 0.8); /* Un poco más oscuro al enfocar */
    outline: none;
}
</style>
